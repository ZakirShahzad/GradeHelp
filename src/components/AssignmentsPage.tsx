...
export const AssignmentsPage: React.FC<AssignmentsPageProps> = ({ onTabChange }) => {
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              <h1 className="text-3xl font-bold text-foreground tracking-tight">Assignments</h1>
              <p className="text-lg text-muted-foreground">
                Manage your assignments and track grading progress
              </p>
            </div>
            <Button 
              variant="premium" 
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredAssignments.map((assignment) => (
              <Card key={assignment.id} className="card-elevated hover:shadow-xl transition-all duration-300 group">
                <CardHeader className="pb-3">
                  <div className="flex items-start justify-between">
